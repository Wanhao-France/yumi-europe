...
function getChatId() {
	...
	if (!lang) {
		return '655b7325d600b968d3152666/DEFAULT_WIDGET';
	}

	if (lang.match('en')) {
		return '655b7325d600b968d3152666/WIDGET_FOR_EN';
	} else if (lang.match('de')) {
		return '655b7325d600b968d3152666/WIDGET_FOR_DE';
	} else if (lang.match('es')) {
		return '655b7325d600b968d3152666/WIDGET_FOR_ES';
    } else if (lang.match('it')) {
		return '655b7325d600b968d3152666/WIDGET_FOR_IT';
	} else {
		return '655b7325d600b968d3152666/DEFAULT_WIDGET';
	}
}
